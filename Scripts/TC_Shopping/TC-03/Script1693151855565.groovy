...
WebUI.callTestCase(findTestCase('TC_Shopping/Reuseable_Test_Case/Launch_APK'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('Add to cart/inp_number of order'), '1', 0)

Mobile.tap(findTestObject('Add to cart/btn_add'), 0)

Mobile.tap(findTestObject('Add to cart/btn_cart'), 0)
